...
def Finder_IETE(time1, time_name1, start1):
    ...
    Write.Print("  PLYM", Colors.green, interval=0.000)
    ...
    # ----- condition pour garantir la forme de l'iete  -----#
        ...
        # ----- regarde si la target a deja ete toucher en volatilité avant affichage  -----#
            ...
            plt.plot([], [], ' ')
            plt.title(f'IETE : {tiker_live} | {time1} {time_name1} | +{pourcent_chercher}% BRUT | +{pourcent_chercher2}% NET | -{pourcent_perdu}% | {note}/10 | {debugage} | {dejatoucher}', fontweight="bold", color='black')
